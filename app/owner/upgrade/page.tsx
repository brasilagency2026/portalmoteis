  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-950 text-white">
      <div className="bg-gray-900 border border-yellow-600/30 rounded-lg p-8 shadow-xl text-center max-w-md w-full">
        ...
        <h1 className="text-3xl font-bold mb-2">Assine o Plano Premium</h1>
        <div className="text-2xl font-extrabold text-yellow-400 mb-4">R$ 199 / mês</div>
        <p className="mb-6 text-lg text-gray-300">
          Aproveite todos os benefícios exclusivos:
        </p>
        <ul className="text-left mb-6 space-y-2 text-base text-gray-200">
          <li className="flex items-center gap-2"><Check size={18} className="text-yellow-400" /> Até <b>10 fotos</b> do seu motel</li>
        ...
        <div>
          <Link href="/owner" className="text-yellow-400 underline hover:text-yellow-300">Voltar para o painel</Link>
        </div>
      </div>
    </div>
  );
